...
&#x20;   label = tf.one\_hot(label, depth=10, dtype=tf.float32)
...
lr\_schedule = CosineDecay(

&#x20;   0.01,

&#x20;   len(train\_dataset) \* epochs
...
&#x20;   'train\_loss': history.history\['loss'],

&#x20;   'valid\_loss': history.history\['val\_loss'],
...
&#x20;   'train\_acc': history.history\['categorical\_accuracy'],

&#x20;   'valid\_acc': history.history\['val\_categorical\_accuracy'],
...
new\_input = test\_image\[0, :, :]

new\_input = tf.cast(new\_input, tf.float32) / 255.0

new\_input = tf.reshape(new\_input, (1, 784))



prediction = model.predict(new\_input)
...
\- \[FashionMNIST Classification Notebook](./practice/fashion\_mnist\_classification.ipynb)

\- \[Baseline MLP Report](./report/fashion\_mnist\_baseline\_report.docx)

\- \[Model Improvement Report](./report/fashion\_mnist\_improvement\_report.docx)
